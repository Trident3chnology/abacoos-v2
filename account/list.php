	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-12">
				<div class="mb-5">
					<div class="mt-4 mb-1">
						<span class="h5">List of Accounts</span>
					</div>
					<div class="card mb-3 d-flex align-items-end justify-content-end">
						<button class="btn btn-icon-only btn-pill btn-primary" type="button" aria-label="Add account"
							title="Add account" data-toggle="modal" data-target="#modal-add-account">
