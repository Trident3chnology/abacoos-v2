...
// Content
$mail->isHTML(true);
$mail->Subject = 'Abacoos Login Attempt Alert';
$mail->Body = '
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        ...
        <h1>Login Attempt Alert</h1>

        <p>Hi there ' . $userFirstName . ',<br>
            We noticed a login attempt on your account.</p>
        ...
        <p>If this was you, you can safely ignore this message. Otherwise, click the button above to review your account
            activity.</p>
