    ...
    <div class="modal-dialog modal-md modal-dialog-centered" role="document" style="max-width: 440px;">
        <div class="modal-content border-0 rounded-2xl position-relative overflow-hidden" style="background-color: #e6e7ee; border: 1px solid rgba(255, 255, 255, 0.8) !important;">
            <div class="modal-body p-4 p-md-5">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center justify-content-center rounded-circle mr-3" style="width: 40px; height: 40px; background: #2D4CC8; box-shadow: 0 4px 12px rgba(45, 76, 200, 0.3);">
                            <i class="fa-solid fa-layer-group text-white" style="font-size: 1.1rem;"></i>
                        </div>
                        <div>
                            <h3 class="mb-0 font-weight-black text-dark" style="font-family: 'Outfit', sans-serif; font-size: 1.35rem; letter-spacing: -0.02em;">Add Category</h3>
                            <p class="text-xs text-gray-500 mb-0 font-weight-bold">Create a new transaction category</p>
                        </div>
                    </div>
                ...
                <form class="form-submit-loader" method="post" action="process.php?action=add_category" enctype="multipart/form-data" name="form" id="form">
                    <div class="form-group mb-4">
                        <label for="addCategoryName" class="text-xs font-weight-black uppercase tracking-wider mb-2 display-block" style="color: #475569 !important; font-size: 0.75rem;">Category Name</label>
                        <div class="d-flex align-items-center bg-primary shadow-inset rounded-pill px-3 py-1.5">
                            <input type="text" class="form-control bg-transparent border-0 font-weight-bold text-dark p-0 shadow-none outline-none w-100" name="addCategoryName" id="addCategoryName" placeholder="Enter category name..." autocomplete="off" required style="color: #0f172a !important; height: 38px;">
                        </div>
                        <div id="addCategoryNameFeedback"></div>
                    </div>
