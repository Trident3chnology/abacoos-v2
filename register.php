...
<body>
            ...
            <div class="auth-card animate__animated animate__fadeIn">
                ...
                <div class="text-center">
                    ...
                    <div class="auth-pill-hint">
                        <i class="fa-solid fa-user-plus mr-1" style="font-size: 0.72rem;"></i> Create Account
                    </div>
                </div>
                ...
                <!-- Form -->
                <form id="form" name="frmRegister" method="post" class="form-submit-loader">
                    ...
                    <div class="form-row">
                        <div class="col-12 col-sm-6">
                            <div class="form-group mb-1">
                                <label for="firstName" class="neu-label">First name</label>
                                <div class="neu-input-wrapper">
                                    <i class="fa-regular fa-user neu-input-icon"></i>
                                    <input type="text"
                                        class="neu-input <?= ($data['field'] == 'firstName') ? 'is-invalid' : ''; ?>"
                                        name="firstName" id="firstName"
                                        value="<?= htmlspecialchars($data['firstName'] ?? ''); ?>"
                                        placeholder="First name" autocomplete="given-name" required autofocus>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group mb-1">
                                <label for="lastName" class="neu-label">Last name</label>
                                <div class="neu-input-wrapper">
                                    <i class="fa-regular fa-user neu-input-icon"></i>
                                    <input type="text"
                                        class="neu-input <?= ($data['field'] == 'lastName') ? 'is-invalid' : ''; ?>"
                    ...
                    <div class="form-group mb-1">
                        ...
                        <div class="neu-input-wrapper">
                            ...
                            <input type="email"
                                ...
                                placeholder="name@example.com" autocomplete="email" required readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-1">
                        ...
                        <div class="neu-input-wrapper">
                            ...
                            <input type="password"
                                ...
                                name="password" id="password" placeholder="Create password" autocomplete="new-password"
                                required>
                    ...
                    <div class="form-group mb-2">
                        <label for="confirmPassword" class="neu-label">Confirm Password</label>
                        <div class="neu-input-wrapper">
                            <i class="fa-solid fa-shield-halved neu-input-icon"></i>
                            <input type="password"
                                class="neu-input neu-input-password <?= ($data['field'] == 'confirmPassword') ? 'is-invalid' : ''; ?>"
                                name="confirmPassword" id="confirmPassword"
                                placeholder="Confirm password" autocomplete="new-password" required>
                            <button type="button" id="toggleConfirmPasswordBtn" class="neu-password-toggle" title="Show or hide password" aria-label="Toggle confirm password visibility">
                ...
                <!-- Login Link Button -->
                <div>
                    <a href="<?= WEB_ROOT; ?>login" class="neu-btn-secondary">
                        <i class="fa-solid fa-right-to-bracket mr-2" style="font-size: 0.82rem; color: var(--neu-primary);"></i>
    ...
    <!-- Interactive Polish: Password Visibility Reveals -->
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            setupToggle('toggleConfirmPasswordBtn', 'confirmPassword', 'toggleConfirmPasswordIcon');
        });
    </script>
</body>
